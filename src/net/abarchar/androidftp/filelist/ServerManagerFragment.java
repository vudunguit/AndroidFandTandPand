...
import net.abarchar.androidftp.MainApplication;
import net.abarchar.androidftp.R;
import net.abarchar.androidftp.filelist.manager.FileEntry;
import net.abarchar.androidftp.transfers.manager.TransferDirection;
 ...
 * @author abachar
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class ServerManagerFragment extends AbstractManagerFragment {
